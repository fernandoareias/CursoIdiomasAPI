...
namespace CursoIdiomas.Infra.Data.Migrations
{
    ...
    [Migration("20210926204215_MapTurma")]
    partial class MapTurma
    {
            ...
            modelBuilder.Entity("CursoIdiomas.Domain.Entities.Turma", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("799e87fe-2ce5-40bf-bd4f-193e9e9e6a6d"),
                            CursoId = new Guid("e0c62bad-3744-4e93-8b77-00588ecd4c5e"),
                            DataInicio = new DateTime(2021, 9, 26, 17, 42, 14, 75, DateTimeKind.Local).AddTicks(9837),
