...
namespace CursoIdiomas.Infra.Data.Migrations
{
    ...
    [Migration("20211006210922_MapEntitiesAndProps")]
    partial class MapEntitiesAndProps
    {
            ...
            modelBuilder.Entity("CursoIdiomas.Domain.Cursos.Curso.Curso", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CargaHoraria = 280,
                            DataInicio = new DateTime(2021, 10, 8, 18, 9, 21, 443, DateTimeKind.Local).AddTicks(3400),
                            Dificuldade = 1,
                            Nome = "Inglês"
                        });
                });
